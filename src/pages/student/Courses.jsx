...
import { PiTranslate, PiMathOperations, PiFlask, PiVideoLight } from "react-icons/pi";
        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-9">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-bold text-neutral-800">الدورات</h2>
                            ...
                            <Card key={index} className="bg-white rounded-3xl p-6 shadow-sm border border-neutral-100">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-neutral-50">
                                    <button
                                        ...
                                        className="bg-indigo-600 text-white rounded-full px-4 py-2 flex items-center gap-2 hover:bg-neutral-700 transition-colors"
                                    >
                                        <span className="text-base font-bold">تفاصيل الدورة</span>
                                        <FiExternalLink className="w-4 h-4" />
                                    </button>
                                    <span className="text-base text-neutral-800 font-bold">{course.price}</span>
                                </div>
                            </Card>
                        ))}
                    </div>
